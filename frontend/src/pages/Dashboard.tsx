...
import { useState } from "react";
import { Link } from "react-router-dom";
import { Star, Sparkles, Users, Zap, Globe, TrendingUp, Shield, Heart, Mic } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
...
const Dashboard = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {/* FIX: Link to SignUp */}
            <Link to="/signup">
              <Button variant="outline">Try Studio</Button>
            </Link>
            <Link to="/signin">
              <Button variant="outline">Sign In</Button>
            </Link>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Voice Conversation</h3>
              <p className="text-muted-foreground">
                AI asks questions in Punjabi. Answer naturally with your voice - no typing needed!
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Upload a product photo to enhance your social media posts (optional).
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Get professional English content with engaging captions ready to share.
              </p>
            </div>
          </div>
      ...
      <footer className="border-t mt-16 py-8">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>©️ 2025 Kalakaar AI. Empowering artisans with AI-powered content creation.</p>
        </div>
      </footer>
    </div>
  );
